...
class Astronauta(Personagem):
  def descrever(self):
    return print(f"Astronauta pronto para a batalha")
  
  def equipar(self, equipamento):
    return print(f"{self.descrever()} Equipando {equipamento.nome()}.")

class PistolaLaser(Equipamento):
  def nome(self):
    return print(f"Pistola Laser")
  
  def usar(self):
    return print(f"Disparando com a pistola a laser")
